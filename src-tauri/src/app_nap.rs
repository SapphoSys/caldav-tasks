...
/// This breaks caldav-tasks' periodic sync and notification timers when the
...
pub fn disable_app_nap() {
    ...
    let reason = NSString::from_str(
        "caldav-tasks needs to perform periodic CalDAV sync and check for task notifications",
    );
