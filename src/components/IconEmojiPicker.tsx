  ...
  return (
    <div className="relative" ref={containerRef}>
      <button
        ...
        className="w-10 h-10 rounded-lg border border-surface-200 dark:border-surface-600 bg-surface-50 dark:bg-surface-700 flex items-center justify-center hover:border-surface-300 dark:hover:border-surface-500 transition-colors cursor-pointer outline-none focus-visible:ring-2 focus-visible:ring-primary-500"
        style={{ color }}
      >
        {emojiValue ? (
        ...
        >
          <div className="flex border-b border-surface-200 dark:border-surface-700">
            <button
              ...
              className={`flex-1 px-4 py-2 text-sm font-medium transition-colors outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-inset ${
                activeTab === 'icon'
              ...
              <div className="px-2 pt-2">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full appearance-none rounded-md bg-surface-100 dark:bg-surface-700 pl-8 pr-2.5 py-2 text-sm text-surface-800 dark:text-surface-200 placeholder:text-surface-400 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500"
                  />
                </div>
              </div>
                    ...
                    <div className="grid grid-cols-9 px-2 pb-1.5">
                      {filteredIcons.map(({ name, icon: Icon }) => (
                        <button
                          ...
                          className="w-full h-8 rounded-lg flex items-center justify-center transition-colors cursor-pointer text-surface-600 dark:text-surface-400 hover:bg-surface-100 dark:hover:bg-surface-700 outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-inset"
                        >
                  ...
                  <EmojiPicker.List
                    ...
                    components={{
                      ...
                      Emoji: ({ emoji, ...props }) => (
                        <button
                          type="button"
                          className="flex flex-1 max-w-[calc(100%/9)] h-8 items-center justify-center rounded-lg text-lg hover:bg-surface-100 dark:hover:bg-surface-700 outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-inset"
                          {...props}
                        >
                          {emoji.emoji}
                        </button>
